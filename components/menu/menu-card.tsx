    ...
    <div className="flex h-full flex-col rounded-[30px] border border-orange-100 bg-white p-4 shadow-sm shadow-orange-950/5">
      ...
      <div className="mt-5 flex flex-1 flex-col">
        <div className="flex items-start justify-between gap-3">
          <div>
            <h3 className="text-xl font-semibold text-stone-950">{t(`items.${item.key}.name`)}</h3>
            <p className="mt-2 text-sm leading-6 text-stone-600">{t(`items.${item.key}.description`)}</p>
          </div>
