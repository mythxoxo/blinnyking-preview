    ...
    <div>
      <section className="bg-[var(--color-dark)] px-4 py-16 text-white sm:px-6 lg:px-8">
        <div className="mx-auto max-w-7xl">
          ...
          <h1 className="mt-4 text-4xl font-semibold">Blinny Kingi menüü</h1>
      ...
      <section className="sticky top-[73px] z-40 border-b border-border bg-background/95 backdrop-blur">
        <div className="mx-auto flex max-w-7xl gap-2 overflow-x-auto px-4 py-3 sm:px-6 lg:px-8">
          {['Kõik', 'Soolased', 'Magusad', 'Lõuna', 'Kombod', 'Joogid'].map((label, index) => {
        ...
        {categoryOrder.map((category, idx) => {
          ...
          return (
            <div key={category} id={category} className="py-8">
              ...
              {category === 'lunch' ? <div className="mt-4 rounded-2xl bg-[var(--color-accent)] px-5 py-4 text-sm font-medium text-[var(--color-dark)]">Lõunapakkumine E-R 11:00–15:00 · −20% soodustus</div> : null}
